...
public static void main(String[] args) {
	...
	System.out.println("Highest salary Employee name :"+sobj.empobj.empname +" "+"salary"+sobj.empobj.salary);
	...
	System.out.println("name of the employee having salary less than average salary");
